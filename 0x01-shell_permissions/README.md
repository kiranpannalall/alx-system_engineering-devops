...
9. Write a script that sets the permissions to the file hello where the owner and group have no permission at all whereas the other users have all the permissions 
